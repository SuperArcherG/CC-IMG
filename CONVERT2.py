# Revised CONVERT.py — single-GPU-consumer with CPU producers and batching
...
def mp4_to_frames(input_path, targetFPS, total_res):
    ...
    # use ffmpeg to produce a temporally-resampled and scaled temp clip (same as your previous logic)
